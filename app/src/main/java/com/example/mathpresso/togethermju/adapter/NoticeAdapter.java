...
public class NoticeAdapter extends CustomAdapter<Notice, NoticeAdapter.ViewHolder> {
    ...
    public NoticeAdapter(RecyclerView recyclerView, ArrayList<Notice> data, Activity context, OnNoticeSelectedListener listener) {
        super(context, data);
        mListener = listener;
        mActivity = context;
    }
